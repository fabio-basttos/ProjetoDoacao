...
public class DoacaoRequest extends StringRequest {
    ...
    private static final String REQUEST_DOACAO_URL = "http://doevida.pe.hu/registro.php";
    private Map<String, String> params;

    public DoacaoRequest(String tipoDoacao, int quantidade, String observacao, Response.Listener<String> listener){
